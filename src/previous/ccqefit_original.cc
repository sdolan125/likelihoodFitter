...
int main(int argc, char *argv[])
{
 ...
 TMatrixDSym cov_xsec(9);
  ...
  CCQESample fake_sam1(0, "genie_MuTrack",v_pedges, v_cthedges,tdata);
  fake_sam1.SetNorm(potD/potMC_genie);
  fake_samples.push_back(&fake_sam1);

  CCQESample fake_sam2(1, "genie_MuPtpc",v_pedges, v_cthedges,tdata);
  fake_sam2.SetNorm(potD/potMC_genie);
  fake_samples.push_back(&fake_sam2);
  
  CCQESample fake_sam3(2, "genie_MuPfgd",v_pedges, v_cthedges,tdata);
  fake_sam3.SetNorm(potD/potMC_genie);
  fake_samples.push_back(&fake_sam3);
  
  CCQESample fake_sam4(3, "genie_MufgdPtpc",v_pedges, v_cthedges,tdata);
  fake_sam4.SetNorm(potD/potMC_genie);
  fake_samples.push_back(&fake_sam4);
  
  CCQESample fake_sam5(4, "genie_CC1pi",v_pedges, v_cthedges,tdata);
  fake_sam5.SetNorm(potD/potMC_genie);
  fake_samples.push_back(&fake_sam5);
  
  CCQESample fake_sam6(5, "genie_DIS",v_pedges, v_cthedges,tdata);
